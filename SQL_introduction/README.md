...
* File:  ` 4-first_table.sql ` 
 Self-paced manual review  Panel footer - Controls 
### 5. Full description
          mandatory         Progress vs Score  Task Body Write a script that prints the following description of the table   ` first_table `   from the database   ` hbtn_0c_0 `   in your MySQL server.
* The database name will be passed as an argument of the  ` mysql `  command
...
* File:  ` 16-no_link.sql ` 
 Self-paced manual review  Panel footer - Controls 
[Done with the mandatory tasks? Unlock 4 advanced tasks now!](https://intranet.hbtn.io/projects/2128/unlock_optionals) 
...
SSHSFTP[Webterm](https://intranet.hbtn.io/user_containers/34894/webterm) 
[Restart]() 
[Destroy]() 
#### Credentials
Host8236f4b79365.cf2b106e.hbtn-cod.ioUsername8236f4b79365Password525d03c39f4c6850554d#### Web access
[HTTPS](https://8236f4b79365.cf2b106e.hbtn-cod.io/) 
[HTTP](http://8236f4b79365.cf2b106e.hbtn-cod.io/) 
[3000](http://8236f4b79365.cf2b106e.hbtn-cod.io:3000/) 
[4000](http://8236f4b79365.cf2b106e.hbtn-cod.io:4000/) 
[5000](http://8236f4b79365.cf2b106e.hbtn-cod.io:5000/) 
[5001](http://8236f4b79365.cf2b106e.hbtn-cod.io:5001/) 
[8000](http://8236f4b79365.cf2b106e.hbtn-cod.io:8000/) 
[8080](http://8236f4b79365.cf2b106e.hbtn-cod.io:8080/) 
#### Port mapping
SSH33017HTTP33016HTTPS33015300033014MySQL33013400033012500033011500133010800033009808033008×#### Recommended Sandboxes
...
No sandboxes yet![Previous project](https://intranet.hbtn.io/projects/3082) 
              Next project            